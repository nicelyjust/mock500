package com.yunzhou.tdinformation.view.binding;
...
public class BindingItem extends RelativeLayout implements View.OnClickListener {
    private static final String TAG = "LoginItem";
    private static final int PASSWORD_LENGTH = 16;
    private static final int AUTH_LENGTH = 11;
    ...
    public BindingItem(Context context) {
        this(context, null);
    }

    public BindingItem(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BindingItem(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initStyle(int type) {
        switch (type) {
            case INPUT_TYPE_PHONE:
                ...
                mEtInput.setFilters(new InputFilter[]{new InputFilter.LengthFilter(4)});
    ...
    static class TimeCount extends CountDownTimer {
        private final WeakReference<BindingItem> mReference;

        public TimeCount(BindingItem loginItem, long millisInFuture, long countDownInterval) {
        ...
        public void onTick(long millisUntilFinished) {
            BindingItem loginItem = mReference.get();
            if (loginItem == null) {
                return;
            }
