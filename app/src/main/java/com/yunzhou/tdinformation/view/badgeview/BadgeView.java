...
public class BadgeView extends View {
    ...
    public BadgeView bind(View view) {
        ...
        if ((view.getParent() instanceof FrameLayout) && hasBind) {
            ...
            if (originHeight == ViewGroup.LayoutParams.WRAP_CONTENT) {
                ...
                containerParams.height = originHeight + topMargin + bottomMargin + verticalSpace;
            }
            if (originWidth == ViewGroup.LayoutParams.WRAP_CONTENT) {
                ...
                containerParams.width = originWidth + rightMargin + horiontalSpace + leftMargin;
            }
