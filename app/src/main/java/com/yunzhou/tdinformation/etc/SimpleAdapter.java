 ...
 *  @描述：
 */
public class SimpleAdapter extends BaseRvAdapter<String> {
    ...
    @Override
    protected void bindHolderView(RecyclerView.ViewHolder holder, String s, int position) {
        if (holder instanceof ArticleHolder) {
            ((ArticleHolder) holder).mTvArticleDetail.setText("item : " + s + ":" + position);
        }
    }
