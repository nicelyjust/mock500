...
import com.yunzhou.tdinformation.pay.RedAdapter;
...
public class UseRedFragment extends LazyBaseFragment2 implements MyRedPacketView,RedAdapter.Callback, View.OnClickListener{
    ...
    public static UseRedFragment newInstance() {
    ...
    private void initRecyclerView() {
        mAdapter = new RedAdapter(mContext, this, RedAdapter.TYPE_MINE);
    ...
    public void onClickCheckUselessRed() {
        mIRedListener.onClickCheckUselessRed();
    }
