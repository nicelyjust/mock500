...
public class CustomLocalFragment extends AbsCustomFragment implements CustomLocalAndHighView, CustomCountryAdapter.Callback, LotteryCategoryAdapter.Callback {
    ...
    public static CustomLocalFragment newInstance() {
        return new CustomLocalFragment();
    }
    ...
    private void createP() {
        mPresenter = new CustomLocalAndHighPresenter(0);
    }
    ...
    @Override
    public void subscribeLotterySuccess(RecommendLotteryEntity entity) {
        mHasCustomAdapter.addItem(entity);
