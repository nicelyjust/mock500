...
public class HighFragment extends LazyBaseFragment2 implements LocalView, View.OnClickListener, CountryAdapter.Callback{
    ...
    private void createP() {
        mPresenter = new LocalPresenter(LocalPresenter.FROM_HIGH);
    }
    ...
    public void onItemClick(int pos) {
        ...
        if (item != null) {
            ...
            ToastUtil.showShort(mContext ,item.getLotteryName());
        }
    }
